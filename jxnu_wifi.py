...
init_url="http://192.168.57.33"
get_challenge_api="http://192.168.57.33/cgi-bin/get_challenge"

srun_portal_api="http://192.168.57.33/cgi-bin/srun_portal"
get_info_api="http://192.168.57.33/cgi-bin/rad_user_info?callback=jQuery112406118340540763985_1556004912581&_=1556004912582"
n = '200'
type = '1'
ac_id='1'
enc = "srun_bx1"
...
def get_wlan_ip_address():
	...
	for interface_name, interface_addresses in interfaces.items():
		for address_info in interface_addresses:
			# 筛选出 WLAN 接口的 IPv4 地址
			if interface_name == 'WLAN' and address_info.family == socket.AF_INET:
